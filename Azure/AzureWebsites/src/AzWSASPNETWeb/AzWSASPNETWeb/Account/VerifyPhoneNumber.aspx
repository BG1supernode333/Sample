<%@ Page Title="電話番号を確認する" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="AzWSASPNETWeb.Account.VerifyPhoneNumber" %>
